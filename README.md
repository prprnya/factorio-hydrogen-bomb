...
- Research cost: 2000 units at 60 seconds per unit.
- Recipe:
  - 1 Atomic bomb
  - 10 Fusion power cells
  - 10 Quantum processors
  - 50 seconds crafting time
- Cyan fusion-themed item icon and a technology icon composed from vanilla visual elements.
...
The hydrogen bomb has an extremely large blast radius. Legendary-quality rocket launch platforms provide enough maximum range for a safe firing window, but close-range launches can still destroy the launcher or player.
